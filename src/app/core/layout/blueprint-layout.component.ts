...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, RouterOutlet, ThreeModelComponent],
...
export class BlueprintLayoutComponent {
  ...
  /** Optional glTF asset to load into the Three.js viewer. */
  protected readonly modelUrl?: string;

  /** Controls how quickly the placeholder rotates when no model is supplied. */
  protected readonly autoRotateSpeed = 0.25;
